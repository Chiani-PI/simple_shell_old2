 ...
 * @info: Param and return_info structs
...
/**
 * find_builtin - Func searches for builtin_cmd
 * @info: Param and return_info structs
 *
...
/**
 * find_cmd - Func searches for cmd_in_PATH
 * @info: Param and return_info structs
 *
 * Return: void
 */
...
/**
 * fork_cmd - Func will fork exe_thread to run_cmd
 * @info: Param and return_info structs
 *
 * Return: void
 */
